...
export default function DropDownSelector(props: DropDownSelectorProps): JSX.Element {
    ...
    const renderItems = (): JSX.Element => {
        if (props.loading) {
            ...
            return (
                <li className="text-red-500 text-center text-3xl">{props.error.message}</li>
            );
    ...
    return (
        <div className="flex m-2 items-center h-max rounded-xl bg-[#70707016] p-3 md:max-w-[33vw] max-w-full flex-wrap max-h-[88px] shadow-md" ref={ref}>
