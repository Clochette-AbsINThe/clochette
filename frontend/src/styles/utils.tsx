...
const SettingsIcon = (props: IconProps): JSX.Element => {
    return (
        <svg className={props.className} viewBox="0 0 16 16" data-testid='Setting'>
            <g fill="currentColor">
...
export function getIcon(name: IconName, className: string = 'w-10 h-10 dark:text-white ml-2 text-black'): JSX.Element {
    switch (name) {
        case 'Glass':
            return <GlassIcon className={className} key='Glass' />;
        case 'Beer':
            return <BeerIcon className={className} key='Beer' />;
        case 'Food':
            return <FoodIcon className={className} key='Food' />;
        case 'Soft':
            return <SoftIcon className={className} key='Soft' />;
        case 'Barrel':
            return <BarrelIcon className={className} key='Barrel' />;
        case 'Misc':
            return <MiscIcon className={className} key='Misc' />;
        case 'Lydia':
            return <LydiaIcon className={className} key='Lydia' />;
        case 'Cash':
            return <CashIcon className={className} key='Cash' />;
        case 'CB':
            return <CBIcon className={className} key='CB' />;
        case 'Setting':
            return <SettingsIcon className={className} key='Setting' />;
    }
}
